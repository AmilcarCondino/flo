...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-10">
            {{  Form::open(array('url' => 'admin/captions', 'files' => true)) }}
            ...
            <div class="row">
                <div class="col-sm-2">
                    ...
                    {{ Form::select('is_photo', [ '0' => 'No', '1' => 'Si' ], '0') }}
                </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    {{ Form::openGroup('parent_id', 'Es epigrafe de:') }}
                        {{ Form::select('parent_id', array('Copetes', 'Selecione el que corresponda' => $captions), array('id' => 'caption_body', 'class' => 'selectpicker')) }}
                    {{ Form::closeGroup() }}
                </div>
                <div class="col-sm-3">
                    {{ Form::openGroup('slide_id') }}
                        {{ Form::text('slide_id', $slide_id, ['class' => 'hide'])  }}
                    {{ Form::closeGroup() }}
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <a class="btn btn-block btn-danger" href="/admin/sliders/{{$slide_id}}/edit" role="button">Cancelar</a>
                </div>
            </div>
            {{ Form::close() }}
        </div>
